...
class VideoViewController: UIViewController {
    ...
    func prepateView() {
        arrayFeed.append(InfoMusicColl(image: UIImage(named: "bg-17") ?? UIImage()))
        arrayFeed.append(InfoMusicColl(image: UIImage(named: "bg-18") ?? UIImage()))
        arrayFeed.append(InfoMusicColl(image: UIImage(named: "bg-19") ?? UIImage()))
        arrayFeed.append(InfoMusicColl(image: UIImage(named: "bg-10") ?? UIImage()))
